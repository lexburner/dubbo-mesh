...
public class AgentApp {
    ...
    // 在Provider端启动agent时，添加JVM参数-Dtype=provider -Dserver.port=30000 -Ddubbo.protocol.port=20880 -Detcd.url=http://localhost:2379
    // 在Consumer端启动agent时，添加JVM参数-Dtype=consumer -Dserver.port=20000 -Detcd.url=http://localhost:2379
