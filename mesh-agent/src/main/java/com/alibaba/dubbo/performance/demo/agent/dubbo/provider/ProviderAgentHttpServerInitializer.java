 ...
 * Date 2018-05-22
 */
public class ProviderAgentHttpServerInitializer extends ChannelInitializer<SocketChannel> {

    private final ProviderAgentClient providerAgentClient;

    ProviderAgentHttpServerInitializer(ProviderAgentClient providerAgentClient){
    ...
    public void initChannel(SocketChannel ch) {
        ...
        p.addLast(new ProviderAgentHttpServerHandler(providerAgentClient));
    }
}
