...
if [[ "$1" == "consumer" ]]; then
  ...
  java -jar -Xms1G -Xmx1G -Dlogs.dir=/root/logs /root/dists/mesh-provider.jar
elif [[ "$1" == "provider-medium" ]]; then
  echo "Starting medium provider service..."
  java -jar -Xms2G -Xmx2G -Dlogs.dir=/root/logs /root/dists/mesh-provider.jar
elif [[ "$1" == "provider-large" ]]; then
  echo "Starting large provider service..."
  java -jar -Xms3G -Xmx3G -Dlogs.dir=/root/logs /root/dists/mesh-provider.jar
else
